...
st.markdown("Ask the user to input two numbers to divide.")
st.markdown("- Handle ValueError if input is not numeric.")
st.markdown("- Handle ZeroDivisionError if the second number is zero.")
st.markdown("- Print appropriate messages for each exception.")
